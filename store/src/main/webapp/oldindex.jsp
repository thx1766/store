...
<body>
    <h2>WebStore - We sell a range of mobile devices to get you on the web faster!</h2>
    
    <table>
    	<tr><td>Products</td></tr>
    	<tr><td><a href="addProduct.jsp">Add Product</a>
    	<br><a href="deleteProduct.jsp">Delete Product</a>
    	<br><a href="listProducts.jsp">List Products</a>
    	...
    	<br><a href="listCartItems.jsp">List Cart Items</a>
